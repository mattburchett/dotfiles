...
require("xdg-menu")			-- Application Menu
...
awful.util.spawn_with_shell("/home/burchettm/.config/awesome/scripts/nm-applet")
...
terminal_nogeo = "/usr/bin/terminal --hide-menubar" -- No Geomertry Terminal
...
myawesomemenu = {
   { "Manual", terminal_nogeo .. " -e 'man awesome'" },
   { "Edit Config", terminal_nogeo .. " -e 'vim"  .. " " .. awful.util.getdir("config") .. "/rc.lua'" },
...
vicious.register(memory, vicious.widgets.mem, 'RAM:<span color = "cyan"> $1%</span>')
...
-- ETH0 --
networketh0 = widget({ type = "textbox" })
vicious.register(networketh0, vicious.widgets.net, 'ETH: D: <span color = "'..beautiful.orange..'">${eth0 down_kb} KB</span> / U: <span color = "green">${eth0 up_kb} KB</span>', 2)

-- WLAN0 --
networkwlan0 = widget({ type = "textbox" })
vicious.register(networkwlan0, vicious.widgets.net, 'WLAN: D: <span color = "'..beautiful.orange..'"> ${wlan0 down_kb} KB</span> / U: <span color = "green"> ${wlan0 up_kb} KB</span>', 2)
